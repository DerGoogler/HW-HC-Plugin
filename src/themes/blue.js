  ...
  plugin.loadCSS({
    "@global": {
      ...
      ".switch__handle": {
        ...
        boxShadow: "0 0 1px 0 rgba(0, 0, 0, .25), 0 3px 2px rgba(0, 0, 0, .25)",
      },
      ...
      ":checked + .switch__toggle > .switch__handle": {
        left: "21px",
        boxShadow: "0 3px 2px rgba(0, 0, 0, .25)",
      },
      ...
      ":checked + .switch--material__toggle": {
        backgroundColor: "rgba(0, 103, 223, 1)",
        fallbacks: [
          {
      ...
      ".switch--material__toggle > .switch--active__handle:before": {
        boxShadow: "0 0 0 14px rgba(0, 0, 0, .12)",
      },
      ":checked + .switch--material__toggle > .switch--active__handle:before": {
        boxShadow: "0 0 0 14px color-mod(#0076FF alpha(20%))",
      },
      ...
      ".range__input": {
        ...
        mozAppearance: "none",
        appearance: "none",
        backgroundImage: "linear-gradient(#0076ff, #0076ff)",
        backgroundPosition: "left center",
      ...
      ".range--material__input::-webkit-slider-thumb": {
        ...
        borderRadius: "0",
        boxShadow: "none",
        backgroundImage: "radial-gradient(circle farthest-corner, #0076FF 0%, #0076FF 6.6px, transparent 7px)",
      ...
      ".range--material__input[_zero]::-webkit-slider-thumb": {
        backgroundImage: "radial-gradient(circle farthest-corner, #f2f2f2 0%, #f2f2f2 4px, #bdbdbd 4px, #bdbdbd 6.4px, transparent 7px)",
      },
      ...
      ".range--material__input::-moz-range-thumb, .range--material__input:focus::-moz-range-thumb": {
        ...
        borderRadius: "0",
        backgroundColor: "transparent",
        backgroundImage: "-moz-radial-gradient(circle farthest-corner, #0076FF 0%, #0076FF 6.6px, transparent 7px)",
        boxShadow: "none",
      },
      ...
      ".range--material__input:disabled::-webkit-slider-thumb": {
        backgroundImage: "radial-gradient(circle farthest-corner, #b0b0b0 0%, #b0b0b0 4px, #eeeeee 4.4px, #eeeeee 7.6px, transparent 7.6px)",
        transition: "none",
      },
      ".range--material__input:disabled::-moz-range-thumb": {
        backgroundImage: "-moz-radial-gradient(circle farthest-corner, #b0b0b0 0%, #b0b0b0 4px, #eeeeee 4.4px, #eeeeee 7.6px, transparent 7.6px)",
        transition: "none",
      },
      ".notification": {
        position: "relative",
      ...
      ".button--outline:active": {
        backgroundColor: "color-mod(#0076ff tint(70%))",
        border: "1px solid #0076ff",
        color: "#0076ff",
        opacity: "1",
      },
      ...
      ".button--material:active": {
        boxShadow: "0 6px 10px 0 rgba(0, 0, 0, .14),\r\n      0 1px 18px 0 rgba(0, 0, 0, .12),\r\n      0 3px 5px -1px rgba(0, 0, 0, .4)",
        backgroundColor: "#0076FF",
        opacity: "0.9",
        transition: "all 0.25s linear",
      },
      ...
      ".button-bar__button:active, :active + .button-bar__button": {
        ...
        borderTop: "1px solid #0076ff",
        borderBottom: "1px solid #0076ff",
        borderRight: "1px solid #0076ff",
        fontSize: "13px",
        width: "100%",
        transition: "none",
      },
      ...
      ".search-input--material": {
        ...
        boxShadow: "0 0 2px 0 rgba(0, 0, 0, .12), 0 2px 2px 0 rgba(0, 0, 0, .24), 0 1px 0 0 rgba(255, 255, 255, .06) inset",
      },
      ".text-input": {
        boxSizing: "border-box",
        backgroundClip: "padding-box",
      ...
      ".progress-bar--material__secondary": {
        backgroundColor: "rgba(0, 84, 182, 1)",
        fallbacks: [
          {
      ...
      "ons-fab.fab:active, ons-speed-dial-item.fab:active, button.fab:active": {
        boxShadow: "0 0 6 rgba(0, 0, 0, .12)",
        backgroundColor: "color-mod(#0076ff a(70%))",
        transition: "all 0.2s ease",
        fallbacks: [
          {
            boxShadow: "0 3px 6 rgba(0, 0, 0, .12)",
          },
        ],
      },
